          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<List<ChatMessageModel>>(
                stream: ref.watch(chatRepositoryProvider).getMessages(userId, chatId),
    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text("اختر منطقة للتعمق في تراثها:", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
        ),
        Container(
          height: 45,
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: ActionChip(
                  label: Text(region.nameAr, style: const TextStyle(fontSize: 12)),
                  backgroundColor: Colors.white,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // 3. زر التسجيل الصوتي
          IconButton(
            icon: Icon(Icons.mic_none_rounded, color: AppColors.primary, size: 26),
            onPressed: () {
  ...
  return Align(
    ...
    child: Container(
      ...
      child: const Row(
        ...
        children: [
          Text("راوي يكتب الآن", style: TextStyle(fontSize: 12, color: Colors.grey)),
          SizedBox(width: 8),
          SizedBox(
            width: 12,
            height: 12,
      ...
      builder: (context) => SafeArea(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              _buildAttachmentOption(Icons.insert_drive_file, "ملف", Colors.blue, () {}),
              _buildAttachmentOption(Icons.camera_alt, "كاميرا", Colors.red, () {}),
